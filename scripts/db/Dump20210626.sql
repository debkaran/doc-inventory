...
INSERT INTO `user_details` VALUES (1,'deb','debkaransinghania@gmail.com','user','debkaran','/home/deb/Downloads/earth.gif',10,'2021-05-13',NULL,NULL,0,NULL,1,0),(2,'Ram','ram@gmail.com','user','ram','/home/deb/Downloads/nature.jpeg',5,'2021-04-30',NULL,NULL,0,NULL,0,0),(9,'user1','user1@gmail.com','user','passOfUser1','c:\\default_picture.jpg',5,'1989-10-15','2021-06-12 18:31:08',NULL,0,NULL,0,0),(10,'user2','user2@gmail.com','user','passOfUser2','c:\\default_picture.jpg',5,'1989-10-15','2021-06-12 20:27:10',NULL,0,NULL,0,0),(25,'Suvankar Sen','suvankar@outlook.com','user','123456','http://localhost:8080/doc-inventory/profile-image?text=S',5,'2020-12-27','2021-06-14 14:14:05',NULL,0,NULL,0,0),(33,'Suvankar Sen','suvankarsen89@gmail.com','user','123456','http://localhost:8080/doc-inventory/profile-image?text=S',5,'2020-12-27','2021-06-19 11:44:11',NULL,0,NULL,0,0);
...
INSERT INTO `user_otp_details` VALUES (1,19,NULL,'oYLLZlKn','2021-06-13 20:23:46',0,0),(2,20,NULL,'vWEaZCxw','2021-06-14 11:30:15',0,0),(3,21,NULL,'qiA22fxN','2021-06-14 12:05:04',0,0),(4,24,NULL,'D9MZ24f7','2021-06-14 14:08:16',0,0),(5,25,NULL,'AO6esewT','2021-06-14 14:14:05',0,0),(6,26,NULL,'uRA5dZTw','2021-06-19 11:00:11',0,0),(7,27,NULL,'zoyIoMpA','2021-06-19 11:08:49',0,0),(8,28,NULL,'enx6z1lc','2021-06-19 11:19:47',0,0),(9,30,NULL,'8ApRaVfA','2021-06-19 11:29:38',0,0),(10,31,NULL,'ZBdetfYZ','2021-06-19 11:31:53',0,0),(11,32,NULL,'YQynHtV8','2021-06-19 11:37:48',0,0),(12,33,'registration','mwc4Uh7x','2021-06-19 11:44:12',0,0),(13,33,'registration','w88wH8Zc','2021-06-23 09:16:29',0,0);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateAccount`(
    ...
    IN profile_picture text,
    IN dob date,
    OUT l_account_id INT
)
BEGIN
...
-- Dump completed on 2021-06-26  9:03:46
